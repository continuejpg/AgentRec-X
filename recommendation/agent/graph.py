...
class AgentGraph:
    ...
    def __init__(self, decision_model: DecisionModel, tool: RecommendationTool) -> None:
...
def build_agent_graph(
    decision_model: DecisionModel, tool: RecommendationTool
) -> AgentGraph:
    """Construct the Milestone 7B agent graph (factory form)."""
    return AgentGraph(decision_model, tool)
